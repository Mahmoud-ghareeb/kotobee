<div class="col-lg-9 order-1 course_col" style="position: relative;" id = "video_player_area">
    ...
    <?php else: ?>
        <div class="" style="position: fixed;width: inherit;">
            <?php
            ...
            if($lesson_details['lesson_type'] == 'video' || $lesson_details['lesson_type'] == '' || $lesson_details['lesson_type'] == NULL):
                ...
                <?php if (strtolower($provider) == 'youtube'): ?>
                    ...
                    <div class="plyr__video-embed" id="player" >
                        <iframe height="450" src="<?php echo $video_url;?>?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1" allowfullscreen allowtransparency allow="autoplay"></iframe>
                    </div>
