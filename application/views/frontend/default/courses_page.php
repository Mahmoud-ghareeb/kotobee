...
<section class="category-course-list-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 d-none d-md-block filter-area">
                        ...
                        <div id="" class="lecture-list collapse show">
                            <ul>
                                ...
                                <li class="lecture has-preview text-14px ">
                                    ...
                                    <span class="lecture-title" onclick="go_course_playing_page('<?php echo $lesson['c_id']; ?>', '<?php echo $lesson['l_id']; ?>')"><?php echo $lesson['l_title']; ?> من كتاب <?php echo $lesson['c_title']; ?></span>
                                    
                                    <!-- <span class="lecture-title d-none" style="margin-right: 77px;color: black;cursor: default;" ></span> -->
